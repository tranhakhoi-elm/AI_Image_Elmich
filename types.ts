...
export type VisualStyle = "CONCEPT" | "TECH_PS" | "COLOR_CHANGE" | "PACKAGING_MOCKUP" | "TECH_EFFECTS" | "WHITE_BG_RETOUCH" | "SCENE_STAGING" | "STUDIO" | "TRACK_SOCKET_STAGING" | "LINE_ART" | "3D_TO_REAL_WHITE_BG" | "BARCODE_QR_GENERATOR" | "PACKAGING_CHECK" | "TRACING_ASSISTANT";
...
export interface PackagingStandardParam {
  key: string;
  value: string;
}
