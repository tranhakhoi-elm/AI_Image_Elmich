...
- **Mirror-Polished Stainless Steel (Inox bóng):**
  - *Material Property:* Highly reflective surface, strong specular highlights, sharp and crisp reflections.
  - *Engineering Prompt:* `"STRICT PRESERVATION: Keep the exact original product (no change in shape, angle, color, material, or texture). Do NOT duplicate or add objects. Do NOT change composition or camera perspective. Material: Mirror-polished stainless steel with high reflectivity. Lighting: soft directional key light from upper-left at 45 degrees, clean studio lighting (premium commercial cookware photography style), highlight on upper rim and inner surface of the pan, smooth light gradient across curved surfaces, no overexposure. Fresnel Physics: Ensure strong, bright specular reflections along the high-curvature profile edges, fading to soft diffuse values on surfaces perpendicular to the camera angle. Structured Specular Highlights: Cylindrical bodies must exhibit sharp, vertical highlights (longitudinal reflections) that outline the 3D form."`
- **Brushed Stainless Steel Finish (Inox xước):**
  - *Material Property:* Lower light reflectivity than mirror-polished stainless steel. Diffused reflections, visible microscopic directional brush lines (anisotropic reflections).
  - *Engineering Prompt:* `"STRICT PRESERVATION: Keep the exact original product (no change in shape, angle, color, material, or texture). Do NOT duplicate or add objects. Do NOT change composition or camera perspective. Material: Brushed stainless steel finish with lower light reflectivity than polished steel. Lighting: soft directional key light from upper-left at 45 degrees, clean studio lighting (premium commercial cookware photography style), highlight on upper rim and inner surface of the pan, subtle reflection on metal handle, smooth light gradient across curved surfaces, no overexposure. Anisotropic Metal Luster: Apply smooth, uniform anisotropic reflections characteristic of premium brushed stainless steel with a blurriness factor of 0.05. Metallic surfaces must be impeccably clean, pristine, perfectly uniform, and seamless."`
- **3D Rendered Stainless Steel Transformation:**
  - *Engineering Prompt:* `"If the input image is a 3D render of a stainless steel product (đồ inox), meticulously process and transform the material shaders, textures, and lighting to make the product look exactly like a highly realistic, premium physical photograph taken in a professional studio. Eliminate artificial 3D plastic/CGI look and replace it with photorealistic metal micro-textures and genuine photographic lighting."`
